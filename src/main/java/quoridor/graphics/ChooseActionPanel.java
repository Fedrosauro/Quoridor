...
public class ChooseActionPanel extends JPanel implements MouseListener, MouseMotionListener, ActionListener {
    ...
    public ChooseActionPanel(JFrame jFrame, GameEngine gameEngine, Color backgroundColor) throws PositionException, NumberOfPlayerException {
        this.jFrame = jFrame;
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (rectMoveB.contains(x, y)) {
            ...
            MoveMeeplePanel playPanel2;
            try {
                playPanel2 = new MoveMeeplePanel(jFrame, gameEngine, backgroundColor);
            } catch (PositionException ex) {
                throw new RuntimeException(ex);
            } catch (NumberOfPlayerException ex) {
                throw new RuntimeException(ex);
            }
            jFrame.setContentPane(playPanel2);
            jFrame.revalidate();
        }
/*
