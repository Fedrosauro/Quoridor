...
public class PlayPanel extends JPanel implements MouseListener, MouseMotionListener, ActionListener {
    ...
    private int size, numberPlayers, wallDimension, numberWalls;
    ...
    public PlayPanel(JFrame jFrame, Color backgroundColor, int size, int numberPlayers, int wallDimension, int numberWalls){
        this.jFrame = jFrame;
